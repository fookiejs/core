...
// Coverage moves in tiny increments as unrelated code lands. Without a little
// slack every refactor that adds one uncovered line turns CI red for a reason
// nobody chose. The ratchet only fires on a real slide.
const TOLERANCE = 0.5;
