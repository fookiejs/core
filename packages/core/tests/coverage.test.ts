...
describe("coverage", () => {
  ...
  it("covers http mutations and errors", async () => {
    ...
    const updated = await httpPost(port, "/httpuser/update", {
      body: { name: "Hu" },
  ...
  it("covers nested failures and running signals", async () => {
    ...
    const user = Model({
      ...
      flow: {
        ...
        async update(flow) {
          return (
            await flow.update(child, { id: { eq: "00000000-0000-7000-8000-000000000001" } }, {
              t: "z",
            })
          ).signal;
        },
    ...
    await fookie.update(user, { id: { eq: "00000000-0000-7000-8000-000000000001" } }, {});
